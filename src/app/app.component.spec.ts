...
import { rothApp } from './app.component';
...
describe('rothApp', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [rothApp],
      schemas: [NO_ERRORS_SCHEMA],
      imports: [
        IonicModule.forRoot(rothApp),
  ...
  beforeEach(async () => {
    fixture = TestBed.createComponent(rothApp);
  ...
  it('should be created', () => {
    expect(component instanceof rothApp).toBe(true);
  });
