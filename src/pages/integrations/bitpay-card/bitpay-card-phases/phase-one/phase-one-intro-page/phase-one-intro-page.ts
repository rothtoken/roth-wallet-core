...
@Component({
  selector: 'page-roth-phase-one-card-intro',
...
export class PhaseOneCardIntro {
  ...
  public openPolicy() {
    let url = 'https://roth.com/about/privacy';
    this.externalLinkProvider.open(url);
  }

  public async orderrothCard() {
    this.rothCardProvider.logEvent('legacycard_order', {});
    let url = 'https://roth.com/visa/get-started';
    this.externalLinkProvider.open(url);
  }
