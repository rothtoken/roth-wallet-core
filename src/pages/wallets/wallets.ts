...
export class WalletsPage {
  ...
  ionViewDidLoad() {
    ...
    const subscribeEvents = () => {
      ...
      // NewBlock, Newrother, NewAddress, NewTxProposal, TxProposalAcceptedBy, TxProposalRejectedBy, txProposalFinallyRejected,
  ...
  private bwsEventHandler = (walletId, type, n) => {
    ...
    if (!wallet) return;
    if (wallet.rotherId == n.creatorId) return;
  ...
  // .fetch => from BWS
  // .update => to UI
  /* This is the only .getStatus call in roth */
