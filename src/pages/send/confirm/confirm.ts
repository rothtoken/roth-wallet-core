      ...
      try {
        ...
        this.popupProvider
          ...
          .then(back => {
            if (!back) {
              const url =
                'https://support.roth.com/hc/en-us/articles/115004671663';
    ...
    setTimeout(async () => {
      ...
      if (multisigContractInstantiationInfo.length > 0) {
        ...
        const multisigEthInfo = {
          ...
          n: this.navParams.data.totalrothers,
    ...
    insufficientFundsInfoSheet.onDidDismiss(option => {
      if (option) {
        this.openExternalLink(
          'https://support.roth.com/hc/en-us/articles/115003393863-What-are-bitcoin-miner-fees-'
        );
