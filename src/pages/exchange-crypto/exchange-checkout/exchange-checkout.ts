            ...
            this.changellyProvider
              ...
              .then(data => {
                ...
                if (
                  ...
                  // changellyFee and apiExtraFee (roth fee) are in percents
                  ...
                  this.rothFee =
                    ...
                    receivingPercentage;
                  this.totalExchangeFee = this.exchangeFee + this.rothFee;
                  this.logger.debug(
                    `Changelly fee: ${this.exchangeFee} - roth fee: ${this.rothFee} - Total fee: ${this.totalExchangeFee}`
                  );
                }
