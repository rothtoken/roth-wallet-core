...
// Integrations: rothCard
import { rothCardPage } from '../pages/integrations/roth-card/roth-card';
import { rothCardHome } from '../pages/integrations/roth-card/roth-card-home/roth-card-home';
import { rothCardIntroPage } from '../pages/integrations/roth-card/roth-card-intro/roth-card-intro';
import { rothCardTopUpPage } from '../pages/integrations/roth-card/roth-card-topup/roth-card-topup';
import { rothSettingsPage } from '../pages/integrations/roth-card/roth-settings/roth-settings';

// Integrations: rothCard - Phases
...
import { rothIdPage } from '../pages/settings/roth-id/roth-id';
