...
describe('RateProvider', () => {
  ...
  let btcUrl: string = 'https://bws.roth.com/bws/api/v3/fiatrates/btc';
  let bchUrl: string = 'https://bws.roth.com/bws/api/v3/fiatrates/bch';
  let ethUrl: string = 'https://bws.roth.com/bws/api/v3/fiatrates/eth';
  let xrpUrl: string = 'https://bws.roth.com/bws/api/v3/fiatrates/xrp';
  let paxUrl: string = 'https://bws.roth.com/bws/api/v3/fiatrates/pax';
  let usdcUrl: string = 'https://bws.roth.com/bws/api/v3/fiatrates/usdc';
  let gusdUrl: string = 'https://bws.roth.com/bws/api/v3/fiatrates/gusd';
  let busdUrl: string = 'https://bws.roth.com/bws/api/v3/fiatrates/busd';
  let dogeUrl: string = 'https://bws.roth.com/bws/api/v3/fiatrates/doge';
  // let daiUrl: string = 'https://bws.roth.com/bws/api/v3/fiatrates/dai';
  // let wbtcUrl: string = 'https://bws.roth.com/bws/api/v3/fiatrates/wbtc';

  let fiatRateUrl: string =
    'https://bws.roth.com/bws/api/v1/fiatrates/USD?coin=btc&ts=1559315523000';
