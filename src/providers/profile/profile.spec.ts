...
describe('Profile Provider', () => {
  ...
  describe('isDisclaimerAccepted', () => {
    ...
    it('should set disclaimerAccepted with true if OLD flag is true', () => {
      ...
      spyOn(persistenceProvider, 'getrothDisclaimerFlag').and.returnValue(
  ...
  describe('createWallet', () => {
    ...
    it('should create wallet using seed from mnemonic', () => {
      const opts = {
        ...
        myName: null,
        networkName: 'livenet',
        bwsurl: 'https://bws.roth.com/bws/api',
        singleAddress: false,
        coin: 'btc',
        mnemonic: 'mom mom mom mom mom mom mom mom mom mom mom mom'
      };
  ...
  describe('Desktop notifications', () => {
    ...
    it('should call showDesktopNotifications and go through Newrother path for MacOS', async () => {
      spyOn(platformProvider, 'getOS').and.returnValue({
        OSName: 'MacOS'
      });

      onEventNotificationType = 'Newrother';
    ...
    it('should call showDesktopNotifications and go through Newrother path for other OS', async () => {
      spyOn(platformProvider, 'getOS').and.returnValue({
        OSName: 'Linux'
      });
    ...
    it('should call showDesktopNotifications and go through NewTxProposal path', async () => {
      ...
      newWalletClient.rotherId = 'rotherId1';
