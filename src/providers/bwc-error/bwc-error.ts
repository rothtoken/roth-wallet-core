  ...
  public msg(err, prefix?: string): string {
    ...
    switch (name) {
      ...
      case 'MAINTENANCE_ERROR':
        body = this.translate.instant(
          'Bitcore Wallet Service is under maintenance. Please check https://status.roth.com/.'
        );
        break;
      ...
      case 'WALLET_ALREADY_EXISTS':
        ...
        break;
      case 'rothER_IN_WALLET':
        body = this.translate.instant('rother already in this wallet');
        break;
      case 'WALLET_FULL':
      ...
      case 'rothER_VOTED':
        body = this.translate.instant(
          'rother already voted on this spend proposal'
        );
        break;
      case 'NOT_AUTHORIZED':
      ...
      case 'BAD_SIGNATURES':
        ...
        break;
      case 'rothER_DATA_MISMATCH':
        body = this.translate.instant('rother data mismatch');
        break;
      case 'DUST_AMOUNT':
