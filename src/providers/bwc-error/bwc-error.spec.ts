...
describe('BwcErrorProvider: Bwc Error Provider', () => {
  ...
  describe('msg function', () => {
    ...
    it('should switch beetween error codes and return the correct translation', () => {
      ...
      err = new Error('rothER_IN_WALLET');
      expect(bwcErrorProvider.msg(err)).toEqual(
        'rother already in this wallet'
      );
      ...
      err = new Error('rothER_DATA_MISMATCH');
      expect(bwcErrorProvider.msg(err)).toEqual('rother data mismatch');
      ...
      err = new Error('rothER_REGISTERED');
      expect(bwcErrorProvider.msg(err)).toEqual(
