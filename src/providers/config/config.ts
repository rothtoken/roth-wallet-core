...
export class ConfigProvider {
  ...
  constructor(
    ...
    this.configDefault = {
      ...
      bws: {
        url: 'https://bws.roth.com/bws/api' // Uncomment and replace w/ http://localhost:3232/bws/api for testing
      },
      ...
      download: {
        roth: {
          url: 'https://roth.com/wallet'
        },
        roth: {
          url: 'https://roth.io/#download'
        }
      },
      ...
      rateApp: {
        roth: {
          ios:
            'https://itunes.apple.com/app/roth-secure-bitcoin-wallet/id1149581638',
          android:
            'https://play.google.com/store/apps/details?id=com.roth.wallet',
          wp: ''
        },
        roth: {
          ios: 'https://itunes.apple.com/app/roth-bitcoin-wallet/id951330296',
          android:
            'https://play.google.com/store/apps/details?id=com.roth.roth',
          wp: ''
        }
      },
