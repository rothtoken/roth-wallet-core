...
export const availableCoins: CoinsMap<CoinOpts> = {
  btc: {
    ...
    paymentInfo: {
      ...
      ratesApi: 'https://bws.roth.com/bws/api/v3/fiatrates/btc',
      blockExplorerUrls: 'roth.com/insight/#/BTC/mainnet/',
      blockExplorerUrlsTestnet: 'roth.com/insight/#/BTC/testnet/'
    },
    feeInfo: {
      feeUnit: 'sat/byte',
      feeUnitAmount: 1000,
  ...
  bch: {
    ...
    paymentInfo: {
      ...
      ratesApi: 'https://bws.roth.com/bws/api/v3/fiatrates/bch',
      blockExplorerUrls: 'roth.com/insight/#/BCH/mainnet/',
      blockExplorerUrlsTestnet: 'roth.com/insight/#/BCH/testnet/'
    },
    feeInfo: {
      feeUnit: 'sat/byte',
      feeUnitAmount: 1000,
  ...
  eth: {
    ...
    paymentInfo: {
      ...
      ratesApi: 'https://bws.roth.com/bws/api/v3/fiatrates/eth',
  ...
  xrp: {
    ...
    paymentInfo: {
      ...
      ratesApi: 'https://bws.roth.com/bws/api/v3/fiatrates/xrp',
  ...
  busd: {
    ...
    paymentInfo: {
      paymentCode: 'EIP681b',
      protocolPrefix: { livenet: 'ethereum', testnet: 'ethereum' },
      ratesApi: 'https://bws.roth.com/bws/api/v3/fiatrates/busd',
      blockExplorerUrls: 'etherscan.io/',
      blockExplorerUrlsTestnet: 'kovan.etherscan.io/'
    },
    feeInfo: {
  ...
  pax: {
    ...
    paymentInfo: {
      paymentCode: 'EIP681b',
      protocolPrefix: { livenet: 'ethereum', testnet: 'ethereum' },
      ratesApi: 'https://bws.roth.com/bws/api/v3/fiatrates/pax',
      blockExplorerUrls: 'etherscan.io/',
      blockExplorerUrlsTestnet: 'kovan.etherscan.io/'
    },
    feeInfo: {
  ...
  usdc: {
    ...
    paymentInfo: {
      paymentCode: 'EIP681b',
      protocolPrefix: { livenet: 'ethereum', testnet: 'ethereum' },
      ratesApi: 'https://bws.roth.com/bws/api/v3/fiatrates/usdc',
      blockExplorerUrls: 'etherscan.io/',
      blockExplorerUrlsTestnet: 'kovan.etherscan.io/'
    },
    feeInfo: {
  ...
  gusd: {
    ...
    paymentInfo: {
      paymentCode: 'EIP681b',
      protocolPrefix: { livenet: 'ethereum', testnet: 'ethereum' },
      ratesApi: 'https://bws.roth.com/bws/api/v3/fiatrates/gusd',
      blockExplorerUrls: 'etherscan.io/',
      blockExplorerUrlsTestnet: 'kovan.etherscan.io/'
    },
    feeInfo: {
  ...
  doge: {
    ...
    paymentInfo: {
      ...
      ratesApi: 'https://bws.roth.com/bws/api/v3/fiatrates/doge',
