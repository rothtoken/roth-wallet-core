...
export class OnGoingProcessProvider {
  ...
  private getProcessNames() {
    const processNames = {
      ...
      fetchingrothAccount: this.translate.instant(
        'Fetching roth Account...'
      ),
      fetchingrothCards: this.translate.instant('Fetching roth Cards...'),
      ...
      connectingrothId: this.translate.instant('Connecting roth ID...'),
